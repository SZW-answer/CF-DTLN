...
├── aux_static_diagnostics.py #Check whether the conditional variable significantly 
├── aux_static_diagnostics.py #interfereswith the target linearity
...
- **Result and Mapping in Quantification of Lag and Intensity in Inland River Basins**: are available at [Google Drive (NC Result)](https://drive.google.com/file/d/1wIHpxKPSLCewfsJcIE5rV3shea-QZ0mY/view?usp=sharing).
...
After training, you can use `03_interpreted_year.py` to run spatial predictions and extract causal relevance scores across your study area.
